...
public class HttpUtility {
     ...
     */
    public static HttpURLConnection sendGetRequest(String requestURL, String  header)
            throws IOException {
    ...
    public static HttpURLConnection sendPostRequest(String requestURL,
        ...
        httpConn = (HttpURLConnection) url.openConnection();
        httpConn.setUseCaches(false);
        //httpConn.setRequestProperty("grant_type=client_credentials&client_id", "57e98f68150ba076398b456c5q9hvtpk3tgc00kk8s4sgckow40gs4080wgc48ogsc4wg04o8c");
        //httpConn.setRequestProperty("client_secret", "5l9wwq20nugw4gswgoso088gw80wccgcw8sco44oo4g84ooco8");
    ...
    public static HttpURLConnection sendPostRequestAA(String requestURL,
            Map<String, String> params) throws IOException {
        URL url = new URL(requestURL);
        httpConn = (HttpURLConnection) url.openConnection();
        httpConn.setUseCaches(false);
